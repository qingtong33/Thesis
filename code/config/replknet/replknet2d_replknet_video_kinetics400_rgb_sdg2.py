...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/replknet2d_relplknet_video_kinetics400_rgb_sdg/epoch_40.pth'
workflow = [('train', 1)]
...
model = dict(
    ...
    backbone=dict(
        type='RepLKNet',
        pretrained='./checkpoints/RepLKNet-31B_ImageNet-1K_224.pth',
...
total_epochs = 140
work_dir = './work_dirs/replknet2d_relplknet_video_kinetics400_rgb_sdg2/'
gpu_ids = range(0, 6)
omnisource = False
module_hooks = []
