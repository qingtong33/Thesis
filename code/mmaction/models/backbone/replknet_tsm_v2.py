...
class ConvFFN(nn.Module):
    ...
    def __init__(self, in_channels, internal_channels, out_channels, drop_path, num_segments=3, shift_div=8):
        super().__init__()
        self.drop_path = DropPath(drop_path) if drop_path > 0. else nn.Identity()
...
class RepLKBlock(nn.Module):
    ...
    def __init__(self, in_channels, dw_channels, block_lk_size, small_kernel, drop_path, small_kernel_merged=False, num_segments=3, shift_div=8):
        super().__init__()
