...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/replknet2d_relplknetTSM_video_minikinetics20_rgb_sdg_V2R/latest.pth'
workflow = [('train', 1)]
...
total_epochs = 90
work_dir = './work_dirs/replknet2d_relplknetTSM_video_minikinetics20_rgb_sdg_V2R/'
gpu_ids = 0
omnisource = False
module_hooks = []