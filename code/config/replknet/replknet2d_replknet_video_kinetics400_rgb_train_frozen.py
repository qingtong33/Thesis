...
optimizer = dict(
        type='Adam',
        lr=0.01, #先这样试试看 用pretrain的参数，0.001-》0.01
        #momentum=0.9, 
        weight_decay=0.0001)  # 从 0.01 改为 0.005

optimizer_config = dict(grad_clip=dict(max_norm=40, norm_type=2))
# 学习策略
lr_config = dict(policy='step', step=[5, 25, 45]) # step 与 total_epoch 相适应
total_epochs = 60 # 从 100 改为 50 50-》60
checkpoint_config = dict(interval=5)

# runtime settings
work_dir = './work_dirs/replknet2d_relplknet_video_kinetics400_rgb_train_frozen_lr=001_60e/'
