...
model = dict(
    ...
    backbone=dict(
        ...
        large_kernel_sizes=[31, 29, 27, 13],#[15, 13, 11, 5][31, 29, 27, 13]
        layers=[2, 2, 18, 2],
...
data = dict(
    ...
    train=dict(
        type='VideoDataset',
        ann_file='data/kinetics400/minikinetics20_train_list_videos.txt',
    ...
    val=dict(
        type='VideoDataset',
        ann_file='data/kinetics400/minikinetics20_val_list_videos.txt',
...
total_epochs = 80
work_dir = './work_dirs/replknet2d_tsrelplknet_video_minikinetics20_rgb_sdg_NP3/'
gpu_ids = 0
omnisource = False
module_hooks = []
