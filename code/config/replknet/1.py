#config of TSRepLKNet a-res on Mini Kinetics-20
model = dict(
    type='Recognizer2D',
    backbone=dict(
        type='RepLKNetTSMV1',
...
log_level = 'INFO'
load_from = None
resume_from = None #'work_dirs/replknet2d_relplknetTSM_video_minikinetics20_rgb_sdg_V2R/latest.pth'
workflow = [('train', 1)]
...
total_epochs = 90
work_dir = './work_dirs/relplknetTSM_new/'
gpu_ids = 0
omnisource = False
module_hooks = []
