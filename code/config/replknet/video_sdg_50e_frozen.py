...
model = dict(
    ...
    backbone=dict(
        ...
        #pretrained2d=True,
        pretrained='./checkpoints/RepLKNet-31B_ImageNet-22K-to-1K_224.pth',#预训练文件位置
...
# runtime settings
work_dir = './work_dirs/replknet2d_relplknet_video_kinetics400_rgb_train_frozen/'